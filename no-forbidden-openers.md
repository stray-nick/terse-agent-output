---
description: Enforce the terse output style. Abort mid-stream when a response opens with forbidden preamble or closes with forbidden filler.
...
You opened or closed with a forbidden phrase from the terse output style.
